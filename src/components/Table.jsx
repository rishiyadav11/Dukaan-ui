...
//   return (
//     <div>
//          <div className="bg-white rounded pt-10 flex justify-between">
...
//     <div className='grid grid-flow-col items-center gap-2 h-9 pl-3.5 pr-3.5 rounded border border-black-150 select-none cursor-pointer'>
//                     <p>Sort</p>
...
//                     </svg>
//                 </div>
//                 <div className='cursor-pointer grid grid-flow-col items-center gap-2 h-9 pl-3.5 pr-3.5 rounded border border-black-150'>
...
const Table = () => {
  return (
    <div className="p-4">
      <div className="bg-white rounded pt-10 pb-4 flex flex-col sm:flex-row justify-between items-center">
        <div className="w-full sm:w-96 h-10 rounded flex items-center border border-black-150">
          <div className="pl-4 pr-4">
            <svg
              width="16"
              height="16"
      ...
      <div className="relative overflow-x-auto mt-4">
        <table className="w-full text-sm text-left text-gray-500">
          <thead className="text-xs font-medium uppercase text-black-400">
            <tr>
